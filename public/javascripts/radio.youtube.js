...
radio.YouTube.Player = Class.create({
  ...
  onPlayerReady : function() {
    ...
    var stateChangeCallback = "radio.YouTube.Player.onStateChange";
...
Object.extend(radio.YouTube.Player, {
  ...
  onStateChange : function(stateId) {
    radio.YouTube.singleton.onStateChange(stateId);
  }
});
...
var onYouTubePlayerReady = function() {
  radio.YouTube.singleton.onPlayerReady();
};
